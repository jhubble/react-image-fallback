...
var ReactImageFallback = function (_Component) {
	...
	_createClass(ReactImageFallback, [{
		...
		value: function render() {
			return typeof this.state.imageSource === "string" ? this.props.renderAsBackground ? _react2.default.createElement("div", _extends({}, (0, _filterInvalidDomProps2.default)(this.props), {
				style: _extends({}, this.props.style, {
					backgroundImage: "url(" + this.state.imageSource + ")"
				})
			})) : _react2.default.createElement("img", _extends({}, (0, _filterInvalidDomProps2.default)(this.props), { src: this.state.imageSource })) : this.state.imageSource;
		}
	}]);
...
ReactImageFallback.propTypes = {
	...
	renderAsBackground: _propTypes2.default.bool
};
